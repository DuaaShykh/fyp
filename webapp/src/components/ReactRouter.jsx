...
import VaccinationRecordVC from '../layout/VCPanel/VaccinationRecordVC';
import VerificationRecordVfc from '../layout/VerificationPanel/VerificationRecordVfc';
...
<Route path="/VaccinationEdit/:v_id" component ={VaccinationEdit} />
<Route path="/VFCEdit/:vfc_id" component={VFCEdit} />
<Route path="/VCEditRecord/:vc_id" component={VCEditRecord} />
<Route path="/VerifierEdit/:verifier_id" component={VerifierEdit} />
<Route path="/VerificationEdit/:vn_id" component={VerificationEdit} />
<Route path="/VaccineEdit/:vaccine_id" component={VaccineEdit} />
<Route path="/DoctorEdit/:doctor_id" component={DoctorEdit} />
<Route path="/PatientEdit/:patient_id" component={PatientEdit} />
...
<Route path="/VerificationRecordVfc" component={VerificationRecordVfc} />
<Route path="/VaccinationRecordVC" component={VaccinationRecordVC} />

...
export default function VFCRegistration() {
 ...
 <Typography style={{fontFamily:"Carter One",color:"#fff",fontSize:40,marginLeft:40}} >
        Verification
      </Typography>
  ...
  {/* <Form.Group as={Col} controlId="vfc_id">
    ...
    <Form.Group as={Col} controlId="admin_id">
      ...
      <Form.Control type="text" name="admin_id"  value={admin_id} onChange={e => onInputChange(e)} placeholder= " Enter Admin_id"   />
    </Form.Group>
  </Form.Row>
<Form.Row>

...
export default function VFCEdit(props) {
...
const loadVFC = async()=>{
  ...
  let {vfc_id} = props.match.params;
  console.log("vfc_id=" + " " + vfc_id)
  // sessionStorage.setItem("vfc_id", vfc_id);

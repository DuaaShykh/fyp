...
export default function VCEditRecord(props) {
...
const loadVC = async()=>{
  ...
  let {vc_id} = props.match.params;
  console.log("vc_id=" + " " + vc_id)
  sessionStorage.setItem("vc_id", vc_id);
 
 
  fetch(`http://localhost:3001/VCRegistration/${vc_id}`, {
    method: "GET",
    headers: {

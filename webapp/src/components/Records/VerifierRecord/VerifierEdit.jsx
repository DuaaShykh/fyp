...
export default function VerifierEdit(props) {
  ...
  const { verifier_id , vfc_id ,f_name , l_name , email, password,date, address, phone, qualification, gender, 
...
const loadVerifier = async()=>{
  ...
  let {verifier_id} = props.match.params;
  console.log("verifier_id=" + " " + verifier_id)
  sessionStorage.setItem("verifier_id", verifier_id);

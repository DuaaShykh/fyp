        ...
        <Card className="adminCard">
          ...
          <CardContent>
            <Row>
              <Col xl={4} id="photo">
                <Image
                  src="https://image.shutterstock.com/image-photo/young-beautiful-happy-businesswoman-sitting-260nw-165623561.jpg"
                  roundedCircle
                  style={{
                    width: 130,
                    height: 120,
          ...
          Edit Profile
           ...
           ? */}
                  <CardContent style={{ fontSize: 17 }}>
                    <p id="admin_id">
                      Admin-ID:{' '}
                      <span style={{ marginLeft: 20 }}> {admin.admin_id} </span>
                    </p>
                    <hr />
                    <p id="name">
                      FullName:{' '}
                      <span style={{ marginLeft: 20 }}> {admin.name} </span>
                    </p>
                    <hr />
                    <p id="password">
                      Password:{' '}
                      <span style={{ marginLeft: 20 }}> {admin.password} </span>
                    </p>
                    <hr />
                    <p id="email">
                      Email:{' '}
                      <span style={{ marginLeft: 20 }}>{admin.email} </span>{' '}
                    </p>
                    <hr />
                    <p id="address">
                      Address:{' '}
                      <span style={{ marginLeft: 20 }}> {admin.address} </span>
                    </p>
                    <hr />
                    <p id="phone">
                      Phone#:{' '}
                      <span style={{ marginLeft: 20 }}> {admin.phone} </span>
                    </p>
                    <hr />
                    <p id="profession">
                      Profession:{' '}
                    ...
                    <p id="gender">
                      Gender:{' '}
                      <span style={{ marginLeft: 20 }}>{admin.gender} </span>{' '}
                    </p>
                    <hr />
                    <p id="dob">
                      DOB: <span style={{ marginLeft: 20 }}>{admin.dob} </span>{' '}
                    </p>
                    <hr />
                    <p id="religion">
                      Religion:{' '}
                      <span style={{ marginLeft: 20 }}>{admin.religion} </span>{' '}
                    </p>
                    <hr />
                    <p id="city">
                      City:{' '}
                      <span style={{ marginLeft: 20 }}> {admin.city} </span>
                    </p>
                    <hr />
                    <p id="state">
                      State:

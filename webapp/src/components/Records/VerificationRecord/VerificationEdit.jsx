...
export default function VerificationEdit(props) {
...
const loadVerification = async()=>{
  ...
  let {vn_id} = props.match.params;
  console.log("vn_id=" + " " + vn_id)
  sessionStorage.setItem("vn_id", vn_id);
  ...
  .then((responseJson) => {
    setVerification(responseJson.data)
